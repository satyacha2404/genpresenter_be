...
public class Wording {
  ...
  public String getStandardWording(VideoServeRequest videoServeRequest) {
    ...
    wording = "Selamat " + this.getTimeGreetings() + " " + this.getGreetingGender(videoServeRequest) + "  " + this.getName(videoServeRequest) + " .\n" +
        "\n" +
        "Kami mengucapkan terima kasih kepada " + this.getGreetingGender(videoServeRequest) + " " + this.getName(videoServeRequest) + " karena telah tertarik untuk memiliki perlindungan produk MiSMART INSURANCE SOLUTION atau MiSSION\n" +
        "\n" +
